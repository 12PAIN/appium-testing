...
public class SavedListObject extends MainPageObject{
    ...
    public void addToList(String listName){
        ...
        this.waitForElementAndClick(By.xpath(ADD_TO_LIST_BUTTON), "Не удалось нажать \"Добавить в список\"", 5);

        try {
            this.waitForElementAndClick(By.xpath(CREATE_NEW_LIST_BUTTON), "Не найдена кнопка создания нового списка", 5);
        } catch (Exception ignored) {}


        this.waitForElementAndSendKeys(By.xpath(LIST_NAME_ELEMENT), listName, "Не удалось ввести имя списка", 5);
